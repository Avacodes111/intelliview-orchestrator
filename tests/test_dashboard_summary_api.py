"""
Unit tests for the dashboard summary endpoint in dashboard_summary_api.py
"""
...
from monitoring.dashboard_summary_api import create_dashboard_routes
...
def test_summary_endpoint_with_mocked_dependencies(
    ...
    assert "today_interviews" in data
